 ...
 */
class Node extends \sarah\Entity\Node implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sarah\\Entity\\Node' . "\0" . 'id', '' . "\0" . 'sarah\\Entity\\Node' . "\0" . 'name', '' . "\0" . 'sarah\\Entity\\Node' . "\0" . 'isEnabled', '' . "\0" . 'sarah\\Entity\\Node' . "\0" . 'sensors');
        }
    ...
    public function getSensors()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSensors', array());
